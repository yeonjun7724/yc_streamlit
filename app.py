...
with col1:
    ...
    try:
        ...
        for idx, crow in c_pts.iterrows():
            ...
            c_icon = BeautifyIcon(icon="map-pin", icon_shape="marker",
                                  background_color=color, border_color="#fff",
                                  text_color="#fff", number=idx+1)
            d_icon = BeautifyIcon(icon="flag-checkered", icon_shape="marker",
                                  background_color=color, border_color="#fff",
                                  text_color="#fff")
